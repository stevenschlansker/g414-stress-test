package org.sugis.g414stresstest;
...
public class G414HashRetrievalTest {
    ...
    public void testKeyRetrieval() throws Exception {
        ...
        HashFileBuilder hfb = new HashFileBuilder(path, 5000);
